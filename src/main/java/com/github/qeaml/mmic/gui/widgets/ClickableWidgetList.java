...
public class ClickableWidgetList extends ElementListWidget<ClickableWidgetPair> {
  public ClickableWidgetList(MinecraftClient client, int width, int height, int top, int bottom, int padding, ClickableWidget... widgets) {
    super(client, width, height, top, bottom, 20+padding);
