...
public class OptionRGBAScreen extends Screen {
  ...
  public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
    ...
    fill(matrices,
      ...
      width/2+100, height/6*5-95,
      ((int)(alpha*255)<<24)|clr);
  ...
  private Text alphaText(double alpha) {
    return Text.translatable("gui.mmic.color.alpha", Math.round(alpha*100));
  }
}
